        ...
        <section id="home" class="hero-unit-fullscreen parallax-window" data-parallax="scroll"
            ...
            <div class="container">
                <div class="hero-content">
                    <h1 class="hero-heading">SISTEM SPP SISWA AIRLANGGA</h1>
                    <p class="lead">Bayar keperluan administrasi Siswa Airlangga Balikpapan.</p>
                    <span class="onepage-links"><a href="/login2"
                            class="btn btn-lg btn-primary">Login siswa</a></span>
                    <span class="onepage-links"><a href="/login"
            ...
            <div class="container ">
              <div class="row text-center py-4">
                <div class="col text-light">
                    Copyright &copy; {{date('Y')}} SPP SMK AIRLANGGA <span style="color: #f57d00;">&#10084;</span>
                </div>
              </div>
            </div>
          </footer>
